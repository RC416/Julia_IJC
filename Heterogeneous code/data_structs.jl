...
module data_structs
export Model_Parameters_Struct, Environment_Struct, 
        Dataset_Struct, Value_Function_Parameters_Struct
...
# Struct to store information used to calculate the pseudo value function.
@with_kw struct Value_Function_Parameters_Struct
    Ṽₙ::Array{Float64, 3}                # each column is a value function iteration
    θₙ::Vector{Model_Parameters_Struct}  # vector of parameter structs for corresponding column in Ṽₙ
    H::Vector{Float64}                  # bandwidth parameter for distance between parameters  
end
